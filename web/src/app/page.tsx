    ...
    <>
      <header className="siteHeader">
        <div>
          ...
          <p>Local single-user tracker with analytics and fast entry flow</p>
        </div>
        <div className="headerActions">
          <button type="button" className="ghostBtn" onClick={() => goTo("dashboard")}>Dashboard</button>
          <button type="button" className="ghostBtn" onClick={() => goTo("library")}>Library</button>
          <button type="button" className="primaryBtn" onClick={() => goTo("book-form")}>Add Book</button>
        </div>
      </header>
      ...
      <main className="layout">
        ...
        <div className="splitLayout">
          <section id="library" className="panel">
            <div className="sectionHead">
              <h2>Library</h2>
              <p className="meta">Filter and inspect your collection quickly</p>
            </div>
                      ...
                      <tr key={b.id}>
                        ...
                        <td className="actionCell">
                          <div className="actionButtons">
                            <button type="button" className="ghostBtn" onClick={() => startEdit(b)}>Edit</button>
          ...
          <section id="book-form" className="panel">
            <div className="sectionHead">
              <h2>{editingId ? "Edit Book" : "Quick Add"}</h2>
              <p className="meta">Use quick fields first, expand for detailed metadata</p>
            </div>
